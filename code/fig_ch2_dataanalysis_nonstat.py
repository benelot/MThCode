...
patient_ids = ['ID07', 'ID07', 'ID07',
               ...
               'ID11', 'ID11', 'ID11',
               'ID11', 'ID11', 'ID11']
time_begins = [[32, 0], [35, 10], [38, 15], # change [32, 10] to [32,0] for fc_change
               [58, 0], [60, 2], [64, 40],
               [60, 5], [62, 10], [64, 55],
               [129, 45], [133, 36], [136, 30]]

ieeg.determine_fc_change(patient_id=patient_ids, time_begin=time_begins, max_sample_size=59*60, t_length=240, save_name='fc_change')
